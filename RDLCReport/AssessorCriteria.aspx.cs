...
{
    public partial class AssessorCriteria : System.Web.UI.Page
    {
            ...
            if (EhsAssesmentID != 0)
            {
                ...
                var EhsTransaction = db.tb_ehs_assessment_score_transaction.Where(x => x.EhsAssesmentID == EhsAssesmentID).Select(x =>
                     new EHSScoreCriteriaClass
                     {
                         ...
                         PercentageCompliances = x.AssessorPercentageCompliance,
                         Compliances = x.AccessorCompliance,
                         Remark = x.AccessorRemark,
                ...
                ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { rp1, rp2, rp3, rp4, rp5, rp6, rp7, rp8, rp10, rp11, rp12,rp13,rp14,rp15});
