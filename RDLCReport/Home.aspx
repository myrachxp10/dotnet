...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="RDLCReport.Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--<div id="Header">
            <div style="width:100%;float:left;background-color:black;font-family:Arial;font-size:larger;color:whitesmoke">Raksha MIS</div>
