...
namespace adapi
{
    public class ADService
    {
        ...
        private static string _uid = "panchaln"; // ConfigurationManager.AppSettings["_uid"].ToString();
        private static string _pwd = "N1l3shxp!000";// ConfigurationManager.AppSettings["_pwd"].ToString();

        private DirectoryEntry myDirectory = new DirectoryEntry("LDAP://kecrpg.com", "panchaln", "N1l3shxp!000"); // pass the user account and password for your Enterprise admin.
        ...
        public string GetUserInfo(string inSAM, string inType, string attr)
        {
            ...
            try
            {
                ...
                //"(&(objectClass=person)(" + userType + "=" + userName + "))";
